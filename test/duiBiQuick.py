...
def main():
    ...
    saveFileUrlPix = ''
    while saveFileUrlPix == '':
        saveFileUrlPix = input("请输入保存文件夹路径：")

    for daoBanFileUrl in daoBanFilesUrl:
        saveFileUrl = saveFileUrlPix + str(daoBanFileUrl)
        ...
        # print(result)
        saveResult(result, saveFileUrl, daoBanFileUrl[0])
